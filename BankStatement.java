...
public class BankStatement{
    ...
    public void createBankStatement(String statementName){
        ...
        try{
            ...
            writer.write("\n");
            writer.write("Address: " + customer.getAddress()[0] + "," + customer.getAddress()[1] + "," + customer.getAddress()[2]);
            writer.write("\n");
            ...
            writer.write("Date of records: " + (new SimpleDateFormat("yyyy/MM/dd HH:mm:ss")).format(new Date())); //Could cause Issue
        }catch(IOException e){
